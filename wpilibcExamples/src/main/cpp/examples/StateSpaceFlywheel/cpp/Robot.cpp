...
class Robot : public frc::TimedRobot {
   ...
   */
  frc::LinearSystem<1, 1, 1> m_flywheelPlant = frc::FlywheelSystem(
  ...
  // reference.
  frc::PlantInversionFeedforward<1, 1> m_feedforward{m_flywheelPlant, 20_ms};

  // The state-space loop combines a controller, observer, feedforward and plant
  // for easy control.
  frc::LinearSystemLoop<1, 1, 1> m_loop{m_flywheelPlant, m_controller,
                                        m_feedforward, m_observer};
