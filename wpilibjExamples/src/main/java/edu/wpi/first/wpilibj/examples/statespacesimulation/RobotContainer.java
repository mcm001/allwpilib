...
package edu.wpi.first.wpilibj.examples.statespacesimulation;
...
import edu.wpi.first.wpilibj.examples.statespacesimulation.subsystems.DriveSubsystem;
...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        // No interior waypoints, so we use an empty list
        List.of(),
