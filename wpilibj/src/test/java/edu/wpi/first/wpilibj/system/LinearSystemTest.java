...
class LinearSystemTest {
  ...
  public void testElevatorSystem() {
    ...
    var model = LinearSystem.createElevatorSystem(DCMotor.getNEO(2), 5, 0.05, 12);
    assertEquals(model.getA().getStorage().getDDRM(), new MatBuilder<>(Nat.N2(),
  ...
  public void testFlywheelSystem() {
    var model = LinearSystem.createFlywheelSystem(DCMotor.getNEO(2), 0.00032, 1.0);
  ...
  public void testIdentifyPositionSystem() {
    ...
    var kv = 1.0;
    var ka = 0.5;
    var model = LinearSystem.identifyPositionSystem(kv, ka);
  ...
  public void testIdentifyVelocitySystem() {
    ...
    var kv = 1.0;
    var ka = 0.5;
    var model = LinearSystem.identifyVelocitySystem(kv, ka);
