...
public class LinearQuadraticRegulatorTest {
  ...
  public static void createArm() {
    ...
    armPlant = LinearSystem.createSingleJointedArmSystem(motors, J, G);
  }
  ...
  public static void createElevator() {
    ...
    var r = 0.0181864;
    var G = 1.0;
    elevatorPlant = LinearSystem.createElevatorSystem(motors, m, r, G);
  }
  ...
  public void testLQROnArm() {
    ...
    var plant = LinearSystem.createSingleJointedArmSystem(motors, 1d / 3d * m * r * r, G);
