...
class LTVDiffDriveControllerTest {
  ...
  private ControlAffinePlantInversionFeedforward<N10, N2, N3> feedforward;
  ...
  void trackingTestNoise() {
    ...
    while (t <= totalTime) {
      kDt = 0.02 + StateSpaceUtil.makeWhiteNoiseVector(Nat.N1(),
      ...
      y = y.plus(StateSpaceUtil.makeWhiteNoiseVector(Nat.N3(),
          new MatBuilder<>(Nat.N3(), Nat.N1()).fill(0.0001, 0.005, 0.005)));
