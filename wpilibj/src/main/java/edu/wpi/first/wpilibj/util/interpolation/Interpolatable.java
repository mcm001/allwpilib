...
/**
 * An object should extend interpolatable if you wish to linearly interpolate between a lower and uppor bound,
 * such as a robot position on the field between timesteps.
