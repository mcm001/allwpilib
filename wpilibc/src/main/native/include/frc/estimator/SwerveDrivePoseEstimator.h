 ...
 * with swerve drive encoder velocity measurements. It will correct for noisy measurements
 * and encoder drift. It is intended to be an easy but more accurate drop-in for SwerveDriveOdometry.
 *
